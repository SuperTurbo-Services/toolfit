...
3. Plan the fix. If it crosses a function boundary, `architect` first. Delegate implementation through provider dispatch using your configured bug-fix descriptor (default your strongest reasoning model) with `isolated-write`, a dedicated worktree, and a specific scope; review the diff.
